...
const CartItems = () => {
	...
	return (
		<div className='z-40 fixed w-screen top-0 left-0 h-screen flex'>
			<div
				className='w-[10%] md:w-[40%] lg:w-[60%] h-full bg-black/50'
				onClick={() => setOpenCart(false)}></div>
				...
				<div className='flex-1 overflow-y-auto px-6 py-4'>
					<div className='space-y-4'>
						{cartItems?.map((eachItem) => {
							const { name, size, price, quantity, id, photoURLs } = eachItem;
									...
									<div className='flex items-center gap-4'>
										...
										<div className='relative'>
											<div
												...
												className='w-16 h-16 bg-gray-200 bg-cover bg-center rounded-lg'></div>
											<button
